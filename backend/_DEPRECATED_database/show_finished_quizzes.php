...
<html lang="en">
  ...
  <body>
<?php
define('DB_MAIN_DSN', 'sqlite:database.db');
...
try {
    ...
    // Prépare une requête de sélection pour récupérer toutes les données de la table FinishedQuizzes
    $stmt = $pdo->query("SELECT * FROM FinishedQuizzes");
    ...
    echo "<thead>";
    echo "<tr>";
    foreach (array_keys($quizzes[0]) as $column) {
