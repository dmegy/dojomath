...
{"statement":"Soit $(u_n)_{n\\in\\N}$ une suite réelle. \\newline Alors  $1 = \\underset{n\\to+\\infty}o(u_n)$ si et seulement si $u_n \\cvg{n\\to+\\infty} +\\infty$.","answer":false},
...
{"statement":"Deux suites bornées $(u_n){n\\in\\N}$ et $(v_n){n\\in\\N}$ telles que $u_n-v_n \\cvg{n\\to+\\infty}  0$ convergent vers la même limite.","answer":false},
