let questions=[{"statement": "Tautologie.","answer":true},{"statement": "$|1-\\pi|>2$.","answer":true},
...
{"statement": "La relation $\\heartsuit$ sur $\\mathbb R^2$ définie par $y\\heartsuit y \\iff x+3y=5$ est une relation d'équivalence.","answer":false},
{"statement": "La relation $\\bullet$ sur $\\mathbb R^2$ définie par $x\\bullet y \\iff (\\exists \\lambda\\in\\mathcal R, x+3y=\\lambda))$ est une relation d'équivalence.","answer":true},
...
{"statement":"Le noyau d'un morphisme d'anneaux est un sous-anneau.","answer":true},
...
{"statement":"L'image réciproque d'un idéal maximal par un morphisme d'anneaux est un idéal maximal.","answer":true},
